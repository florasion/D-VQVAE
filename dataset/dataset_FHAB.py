...
class FHAB_diversity(data.Dataset):
    def __init__(self):
        #self.obj_root = './models/HO3D_Object_models'

        obj_pc_dict, obj_face_dict, obj_scale_dict, obj_pc_resample_dict, obj_resample_faceid_dict = utils_HO3D_FPHA.load_objects_FPHA()
