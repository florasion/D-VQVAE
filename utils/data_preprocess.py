...
mode = 'test'
file_path = './ObMan/obman/{}.txt'.format(mode)
mano_trans_path = './ObMan/mano-fit/{}/mano_trans.json'.format(mode)
mano_rot_path = './ObMan/mano-fit/{}/global_rot.json'.format(mode)
obj_mesh_path = './ObMan/obman/{}/models_resampled'.format(mode)
img_root='./ObMan/obman'
...
pc_save_path = './ObMan/obman/processed/obj_pc_{}.npy'.format(mode)
...
param_save_path = './ObMan/obman/processed/hand_param_{}.npy'.format(mode)
