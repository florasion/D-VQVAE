...
import imageio
import skvideo
skvideo.setFFmpegPath(r'/home/zhaozhe/Pycode/ffmpeg/bin')
...
def run_simulation(
    ...
    for step_idx in range(num_iterations):
        ...
        if save_video:
            ...
            #image.save('example_image{}.png'.format(step_idx))
    ...
    if save_video:
        imageio.mimsave(save_video_path, images, duration=0.1)
