...
def main(args, model, cmap_model, eval_loader, device, rh_mano, rh_faces):
    ...
    for batch_idx, (obj_id, obj_pc, origin_verts, origin_faces) in enumerate(eval_loader):
        ...
        for i in range(1000000):
            ...
            vhacd_exe = "/home/ubuntu/CODE/v-hacd-master/app/TestVHACD.exe"
            try:
        ...
        save_path = './diverse_grasp/obman/obj_id_{}.json'.format(int(obj_id.item()))
        data = {
...
if __name__ == '__main__':
    ...
    parser.add_argument("--simu_disp_thre", type=float, default=0.2)  # 3cm
