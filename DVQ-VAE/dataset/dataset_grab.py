...
class GRAB_diversity(data.Dataset):
    def __init__(self):
        ####change the path to your path
        self.obj_root = '/data/GRAB_unzip'

        obj_pc_dict, obj_face_dict, obj_scale_dict, obj_pc_resample_dict, obj_resample_faceid_dict = utils_HO3D_FPHA.load_objects_GRAB()
    ...
    def __getitem__(self, idx):
        ...
        return obj_pc, origin_verts, origin_faces
